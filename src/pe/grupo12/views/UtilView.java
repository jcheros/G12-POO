...
public class UtilView {
    ...
    public final static String MENU_RETIRO = ""
            ...
            + "\t1- S/ 20 \t4- S/ 100\n"
            + "\t2- S/ 40 \t5- S/ 200\n"
            + "\t3- S/ 60 \t6- Cancelar transacción\n"
            + "Elija su monto de retiro: ";
    public final static String MENSAJE_DATO_INCORRECTO = "Datos incorrectos";
    public final static String MENSAJE_SALDO_INSUFICIENTE_CAJERO = "El cajero no cuenta con saldo suficiente. Intente con un valor menor.";
    ...
    public final static String MENSAJE_DEPOSITO = "Ingrese el monto a depositar (o cero para cancelar) S/: ";
